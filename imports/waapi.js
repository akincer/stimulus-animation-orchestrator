...
export function buildKeyFrameEffect(subscriber, subscription, section = sectionFull) {
    ...
    !!subscription['easing'] ? console.log("-> buildKeyFrameEffect !!subscription['easing'] returned true - actual value: ", subscription['easing']) : console.log("-> !!subscription['easing'] returned false using default - actual value: ", subscription['easing'], 'Truth check value: ', !!subscription['easing']);
