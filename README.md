...
| data-orchestrator-default-easing             | document.orchestrator.defaults.easing        | Default rate of change of an animation.                                   | linear           | [:information_source:](https://developer.mozilla.org/en-US/docs/Web/CSS/easing-function)     |
